"""Tests for WritePipeline — validator chain, WriteRule clamp/reject."""
...
def _make_pipeline(
    ...
    if register_defs is None:
        register_defs = [
            GatewayRegisterDef(name="power", address=0, data_type=UInt16(), initial_value=0),
            GatewayRegisterDef(name="voltage", address=10, data_type=UInt16(), initial_value=0),
        ]
