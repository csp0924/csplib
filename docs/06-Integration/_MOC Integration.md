...
| 頁面 | 類型 | 說明 |
|------|------|------|
| [[Command Refresh]] | guide/class | `CommandRefreshService`：reconciler，把 desired state 週期重傳到設備 |
...
| [[Reconciliation Pattern]] | architecture | Kubernetes reconciler 設計模式與 CommandRefreshService 實作（v0.8.1） |
